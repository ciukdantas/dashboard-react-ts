...
const Cadrastarinformaçoes: React.FC = () => {
    ...
    const validationSchema = Yup.object().shape({
        foto: Yup.string().required('Foto obrigatorio'),
        nome: Yup.string().required('Nome obrigatorio'),
        cargo: Yup.string().required('Cargo obrigatorio'),
        resumo: Yup.string().required('Resumo obrigatorio'),
...
export default Cadrastarinformaçoes;